...
planned: { label: "Planifié", className: "bg-slate-50 text-slate-600 border-slate-200" },
...
planned: { label: "Planifiée", className: "bg-blue-50 text-blue-700 border-blue-200" },
completed: { label: "Complétée", className: "bg-emerald-50 text-emerald-700 border-emerald-200" },
