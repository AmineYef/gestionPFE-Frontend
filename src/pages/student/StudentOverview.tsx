...
import { mockDashboardStats, mockJournalEvents, mockProject } from "@/data/mockData";
...
<ProgressBar value={stats.progressPercent} size="lg" showLabel={false} />
</div>
</div>
...
<h3 className="font-semibold text-sm">Avancement par sprint</h3>
<Link
to="/student/sprints"
...
<div className="rounded-xl border bg-card p-5">
<div className="flex items-center justify-between mb-4">
<h3 className="font-semibold text-sm">Dernières réunions</h3>
<Link
to="/student/meetings"
className="text-xs text-muted-foreground hover:text-foreground flex items-center gap-1"
>
...
<div className="rounded-xl border bg-card p-5">
<div className="flex items-center justify-between mb-4">
<h3 className="font-semibold text-sm">Dernier rapport</h3>
<Link
to="/student/reports"
className="text-xs text-muted-foreground hover:text-foreground flex items-center gap-1"
>
...
<span>
{new Date(stats.lastReportVersion.uploadedAt).toLocaleDateString(
"fr-FR"
)}
</span>
...
<p className="text-sm text-muted-foreground">Aucun rapport déposé</p>
