import { mockProject, mockSprints, mockTasks, mockUserStories } from "@/data/mockData";
import { SprintStatusBadge, ProgressBar } from "@/components/shared/Badges";
...
<div>
<p className="text-xs text-muted-foreground">Encadrant universitaire</p>
...
<div>
<p className="text-xs text-muted-foreground">Encadrant entreprise</p>
...
{new Date(activeSprint.startDate).toLocaleDateString("fr-FR")} →{" "}
